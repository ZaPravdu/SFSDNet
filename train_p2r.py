...
def parse_args():
    ...
    parser.add_argument('--use-variance-reg', action=argparse.BooleanOptionalAction, default=False)

    # ── 路径/模式 ──
    parser.add_argument('--validate-mode', action=argparse.BooleanOptionalAction, default=True)
